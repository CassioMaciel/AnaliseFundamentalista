...
echo "Ticker;Qtd;;Cotação;LPA;VPA;;Valor Merc.;Lucro;Patrimonio Liq.;;Valuation"> /tmp/$$_carteira.csv
...
do
	...
	echo "$Ticker;$Qtd;;$Cotacao;=$LucroLiq/$NroAcoes;=$PatrLiq/$NroAcoes" >> /tmp/$$_carteira.csv
done
